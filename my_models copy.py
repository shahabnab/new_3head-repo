...
def build_DA_AE(seq_len: int, n_domains: int, latent_dim: int,ENC_CONST_COEF:float, DEC_CONST_COEF:float) :
        ...
        dom_logits = layers.Dense(n_domains, name="domain_logits",activation="softmax")(grl(latent))
        ...
        los_logits = layers.Dense(1, activation="sigmoid",name="los_logits")(gated) 
        ...
        ae = models.Model(
            ...
            outputs = [recon, dom_logits, los_logits],
